...
import { _namedColors } from "./converters.js";
import { VisionDeficiencyType } from "./types.js";
...
// console.time("regex");
// console.log(Color.patterns.named.test("sss"));
// console.timeEnd("regex");

// console.time("in");
// console.log("sss" in _namedColors);
// console.timeEnd("in");
